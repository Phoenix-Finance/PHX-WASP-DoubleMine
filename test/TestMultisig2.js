...
//,emergencyWithdraw,quitPhxFarm,quitExtFarm
  it("[0020] multisig for emergencyWithdrawExtLp,should pass", async()=>{
    ...
    let msgData = phxfarmproxyinst.contract.methods.emergencyWithdrawExtLp(0).encodeABI();
    ...
    res = await testViolation("multiSig distributeFinalExtReward: This tx is not aprroved",async function(){
      await phxfarmproxyinst.emergencyWithdrawExtLp(0,{from:operator0});
    });
    ...
    res = await testViolation("multiSig emergencyWithdrawExtLp: This tx is not aprroved",async function(){
      await phxfarmproxyinst.emergencyWithdrawExtLp(0,{from:operator0});
    });
