...
var web3 = new Web3(new Web3.providers.HttpProvider("https://rinkeby.infura.io/v3/a118b723838b42a09c27378fd7b75e95"));
...
async function checkpara() {
  ...
  let r2 = await minePool.methods.totalStaked(0).call();
  console.log(r2)

  let r3 = await minePool.methods.allPendingReward(0,'0x484ECe1FEB86310518f32dB42c0977E2757Ad03b').call();
  console.log(r3[0],r3[1],r3[2])

  let res = await minePool.methods._poolInfo(0).call();
